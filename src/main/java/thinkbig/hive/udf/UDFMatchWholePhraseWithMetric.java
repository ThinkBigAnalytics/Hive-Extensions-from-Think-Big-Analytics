...
public final class UDFMatchWholePhraseWithMetric extends UDF {  
  public BooleanWritable evaluate(final Text text, final Text pattern, Text algoType) {
    ...
    return new BooleanWritable(MatchUDFUtil.match(text.toString(), pattern.toString(), algoType.toString(), MatchType.WholePhrase));
  }
}
